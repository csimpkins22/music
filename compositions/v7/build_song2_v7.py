#!/usr/bin/env python3
"""
Song 2 v7: "The Machinery of Sunlight"
Key: F major (modulates to Gb for final chorus) | Tempo: 92 BPM | 4/4 | ~3:50

v7 songwriter notes — FINAL POLISH:
Building on v6 with two finishing touches:

FIX 1: ENDING LANDING — The outro currently evaporates. On the very last bar of
  the song, a single whole-note bass note (Gb2, vel=20) rings alone after the pad
  fades. One final low note that says "this is where we are now."

FIX 2: CLIMAX PEAK SHARPNESS (bars 44-47) — Snare velocity boost concentrates at
  the very end. Bars 44-45: no boost. Bar 46: boost=6. Bar 47: boost=12. This makes
  bar 47 the unmistakable peak right before the pre-chorus breath.
"""
...
for i in range(16):
    ...
    # v7 FIX 2: Bars 44-47 (i=12..15) — snare velocity boost concentrates at the end.
    # Bars 44-45 (i=12,13): no boost. Bar 46 (i=14): boost=6. Bar 47 (i=15): boost=12.
    snare_boost = 0
    if i == 14:
        snare_boost = 6
    elif i == 15:
...
# v7 FIX 1: ENDING LANDING — single whole-note Gb2 on the very last bar (bar 84).
# Rings alone after the pad fades. One final low note.
E.note(6, N('Gb',2), 20, bt(b + 7), BAR4 - 30, time_amount=10, vel_amount=4)
...
build_midi(E, 'The Machinery of Sunlight', bpm=92, total_bars=85,
           ...
           output_path='/home/user/music/compositions/v7/02_the_machinery_of_sunlight.mid')
