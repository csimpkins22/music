"""
Shared humanization and MIDI utility library for v3 compositions.
...
def make_chord(root, quality='major'):
    ...
    elif quality == 'aug': return [root, root+4, root+8]
    elif quality == '6': return [root, root+4, root+7, root+9]
    elif quality == 'min6': return [root, root+3, root+7, root+9]
    elif quality == 'min9': return [root, root+3, root+7, root+10, root+14]
    elif quality == 'maj9': return [root, root+4, root+7, root+11, root+14]
    elif quality == '9': return [root, root+4, root+7, root+10, root+14]
    elif quality == 'sus2add6': return [root, root+2, root+7, root+9]
