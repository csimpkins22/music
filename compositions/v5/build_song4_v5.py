#!/usr/bin/env python3
"""
Song 4 v5: "Last Signal Home"
Key: G major | Tempo: 58 BPM | 3/4 | ~4:27

v5 changes — handcrafted improvements:
1. Verse 1 bars 10-11: Break stepwise C6→B5 descent with rest + chromatic passing Bb5
2. Chorus 1 bass bars 26, 30: Bass counter-riff (quarter-note patterns) on Em and G bars
3. Bridge bars 56-59 (no drums): Add clean sustained pedal steel D5 (vel=28) filling the void
4. Final chorus bars 72-74: Rewrite approach to G6 peak — leap from rest to E6 earns the climax
...
def bass_counter_riff(bar_start, notes, vel=46, bar_num=0):
    """Bass plays a quarter-note pattern of 3 notes in 3/4 time."""
    bvel = breathing_vel(vel, bar_num, 8, 4)
...
build_midi(E, 'Last Signal Home', bpm=58, time_sig_num=3, total_bars=86,
           ...
           output_path='/home/user/music/compositions/v5/04_last_signal_home.mid')
