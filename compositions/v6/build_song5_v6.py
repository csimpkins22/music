...
v5 changes (handcrafted):
1. Verse 1 bars 10-11: synth counter-melody (E5->G5 rising m3) after vocal Bb->D fall — call-and-response
2. Verse 2 drums bars 32-47: ghost kick on &2 every EVEN bar (34,36,38...), ghost snare on &4 every ODD bar (35,37,39...) — alternating pocket
3. Instrumental lead motif: 2nd and 4th appearances INVERTED (A->F->D descending) — call-and-response not just transposition
4. Verse 3 melody recovery: chromatic approach C#5 (eighth) then D5 (held) instead of direct D5 return
"""
